        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="{{ url('/pasiens') }}"> <i class="menu-icon fa fa-dashboard"></i>Data Pasien </a>
                    </li>
                    <li class="active">
                        <a href="{{ url('/doctors') }}"> <i class="menu-icon fa fa-dashboard"></i>Data Dokter </a>
                    </li>
                    <li class="active">
                        <a href="{{ url('/hospitals') }}"> <i class="menu-icon fa fa-dashboard"></i>Daftar Rumah Sakit
                        </a>
                    </li>
                    <li class="active">
                        <a href="{{ url('/apoteks') }}"> <i class="menu-icon fa fa-dashboard"></i>Daftar Apotek </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
                            ...
                            <div class="dropdown-menu" aria-labelledby="message">
                                ...
                                <a class="dropdown-item media bg-flat-color-1" href="#">
                                    ...
                                    <span class="message media-body">
                                        <span class="name float-left">Ais</span>
